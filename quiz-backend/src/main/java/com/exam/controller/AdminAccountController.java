...
public class AdminAccountController {
    ...
    public ResponseEntity<?> createStudent(@RequestBody Map<String,String> body){
        ...
        User u=new User(); u.setName(name.trim()); u.setEmail(email); u.setPasswordHash(passwordEncoder.encode(password)); u.setRole(User.Role.STUDENT); u.setDisplayId(displayIdService.next(User.Role.STUDENT)); u.setAccountEnabled(true); u.setMfaEnabled(false); userRepository.save(u);
